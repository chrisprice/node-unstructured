...
/**
 * Search the sourceFolders in order for a matching relativePath and if found read
 * the contents of the file.
 *
 * @param sourceFolders An array of folder paths.
 * @param relativePath The realtive path to search for.
 * @param cb The callback, invoked with the error, absolute path and file content.
 */
